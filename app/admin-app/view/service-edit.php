            ...
            <form id="demo-form2" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="title" name="title" class="form-control " value="<?php echo $service["title"] ?>">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <textarea name="content"><?php echo $service["content"] ?></textarea>
                        <script>
                ...
                <div class="item form-group">
                    <div class="col-md-6 col-sm-6 offset-md-3">
                        <button type="submit" name="edit-service" class="btn btn-success">Kaydet</button>
                    </div>
                </div>
            </form>
        </div>
